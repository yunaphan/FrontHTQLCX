...
<div>
    ...
    ref="form"
    class="form-add-user"  
    @submit.prevent="getApiUpdateUser()">
      <v-card>
        <v-card-title>
          <div class="text-center">
            ...
            class="logo-avatar">
              ...
              <img id="output" v-else :src="user.duongdanavatar" alt="image avatar">
            </v-avatar>
          </div>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text type="submit">Cập nhật</v-btn>
          <v-btn color="blue darken-1" text @click="getApiDeleteUser">Xóa người dùng</v-btn>
        </v-card-actions>
      </v-card>
  </form>
</div>
  ...
  export default {
    ...
    methods: {
      ...
      getApiUpdateUser() {
        ...
        .then(() => {
          alert("Cập Nhật thông tin người dùng "
            +this.user.lastname
